...
const { getMerchants, getMerchantById, registerMerchant, loginMerchant, forgetMerchantPassword, resetMerchantPassword, getMerchantInfo, editMerchantInfo } = require('./merchant');
...
const { getUsers, registerUser, loginUser, forgetUserPassword, resetUserPassword, getUserById, getUserInfo, addBank, editSavingsPlan, getUsersByMobile, editUserInfo, applyAgent, getUserAgents, toggleAgent } = require('./user');
...
router.post('/merchants', newTAC, catchAsyncErrors(registerMerchant));
router.post('/merchants/login', catchAsyncErrors(loginMerchant));
router.post('/merchants/forget-password', existingTAC, catchAsyncErrors(forgetMerchantPassword));
router.post('/merchants/reset-password', userTAC, merchantAuth, catchAsyncErrors(resetMerchantPassword));
router.post('/merchants/me', merchantAuth, catchAsyncErrors(getMerchantInfo));
router.post('/merchants/edit', merchantAuth, imageUpload, catchAsyncErrors(editMerchantInfo));
...
/*router.get ('/notifications',                 userAuth,               catchAsyncErrors(getNotifications));
router.post('/notifications/clear',           userAuth,               catchAsyncErrors(clearNotifications));*/
