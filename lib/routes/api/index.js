...
const { getUsers, registerUser, loginUser, forgetUserPassword, resetUserPassword, getUserById, getUserInfo, updateCoordinates, addBank, editSavingsPlan, getUsersByMobile, editUserInfo, applyAgent, acceptAgent, declineAgent, getUserAgents, toggleAgent, clearNotifications } = require('../../controllers/user');
...
const { getPayments, sendPayment, acceptPayment, requestPayment, topUpVolet, withdrawFromAgent, acceptWithdrawal, rejectWithdrawal } = require('../../controllers/volet');
...
router.get('/static', userAuth, asyncHandler(getStaticPages));
...
router.post('/users/agent/approve',       adminAuth,                  asyncHandler(acceptAgent));
router.post('/users/agent/decline',       adminAuth,                 asyncHandler(declineAgent));
...
router.post('/volet/payments/accept', userAuth, asyncHandler(acceptPayment));
//todo accept request
router.post('/volet/withdraw/agent', userAuth, asyncWrapper(withdrawFromAgent));
