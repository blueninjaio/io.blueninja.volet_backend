...
const { getUsers, registerUser, loginUser, forgetUserPassword, resetUserPassword, getUserById, verifyUser, addBank, toggleSavingsPlan, getUsersByMobile, editUserInfo, applyAgent, getUserAgents, toggleAgent } = require("./user");
...
const { getPayments, sendPayment, requestPayment, topUpVolet, withdrawVolet } = require("./volet");
...
router.post('/volet/withdraw',                userAuth,               catchAsyncErrors(withdrawVolet));
